...
async def impostor(event):
    ...
    if inputArgs in AyiinXd:
        await edit_delete(event, "**[KONTOL] - Tidak dapat menyamar sebagai developer Ayiin-Userbot 😡**")
    ...
    if inputArgs:
        ...
        if replyMessage.sender_id in DEVS:
            return await xx.edit("**[KONTOL] - Tidak dapat menyamar sebagai developer Ayiin-Userbot 😡**")
