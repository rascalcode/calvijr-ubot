...
async def autopilot():
    LOGS.info("TUNGGU SEBENTAR TOD. SEDANG MEMBUAT GROUP LOG USERBOT UNTUK LU")
    ...
    try:
        ...
        LOGS.info(
            "Terjadi kesalahan, Buatlah sebuah grup publik lalu masukkan @MissRose_bot ketik /id lalu isi id nya di config var BOTLOG_CHATID."
        )
        exit(1)
